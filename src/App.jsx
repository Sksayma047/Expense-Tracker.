...
const App = () => {
  ...
  const [type, setType] = useState("income"); // Added state for transaction type
  ...
  const addTransaction = () => {
    if (description && amount && !isNaN(amount) && parseFloat(amount) > 0) {
      ...
      alert("Please fill in all fields correctly before adding a transaction.");
    }
  };
      ...
      <div className="max-w-md w-full p-3 rounded-lg bg-white items-center shadow-md border border-white mb-5">
        ...
        <div className="mt-4">
          <input
            ...
            className="w-full p-2 mb-3 text-xl placeholder-gray-400 text-gray-700 border border-gray-300 rounded"
          ...
          <select
            ...
            className="w-full p-2 mb-3 text-xl text-gray-700 border border-gray-300 rounded"
          >
